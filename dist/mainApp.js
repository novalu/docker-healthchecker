...
const LoggerConsumerConfig_1 = require("./manager/containers_processor/configuration/consumer_config/impl/LoggerConsumerConfig");
...
(() => __awaiter(void 0, void 0, void 0, function* () {
    let app;
    try {
        const consumerConfigs = [new LoggerConsumerConfig_1.LoggerConsumerConfig(true)];
        const configuration = new Configuration_1.Configuration(["test"], "images-def-example.json", consumerConfigs);
