...
let SlackConsumer = class SlackConsumer {
    ...
    consume(containers, consumerConfig) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!(consumerConfig instanceof SlackConsumerConfig_1.SlackConsumerConfig)) {
                throw new Error("Message config is not Slack message config");
            }
            const slackConfig = consumerConfig;
            const webhook = new webhook_1.IncomingWebhook(slackConfig.webhook);
            yield webhook.send({
